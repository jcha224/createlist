 ...
 * @author Kaiyaun Shi, Monika; modified by John Chang
...
public class ArrayListUnsortedTest {
	...
	/**
	 * test removeAtIndex by remove out of bound index from previous last index
	 */
	@Test (expected = IndexOutOfBoundsException.class)
	public final void removeAtIndexlastFalse() {
		al.insert("aaa");
		al.removeAtIndex(0);
		al.removeAtIndex(0);	
	}
